...
class ShotGenerator(Protocol):
    ...
    The concrete FastVideo adapter will translate one ShotPlan into the
    existing FastVideoProvider request/result contract.
    """
...
class LongVideoWorkflow:
    ...
    async def _generate_current_shot(
        ...
        try:
            ...
            return {
                "completed_shot_paths": completed,
